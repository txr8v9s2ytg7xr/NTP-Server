...
#This script is meant to set up a NTP server that you can solicit for the correct system time
#Enjoy ;)
clear
echo "Welcome to the NTP server installation by txr8v9s2ytg7xr.us!"
sleep 0.4
